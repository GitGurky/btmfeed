--[[
	BottomFeeder
	Revision: $Id: btmMain.lua 1065 2006-10-12 02:11:59Z root $
...
BtmFeed.BeginScan = function ()
	...
	BtmFeed.Log(format("I have %d gold %d silver %d copper.", gold, silver, copper))
	BtmFeed.Print(format("I have %d gold %d silver %d copper.", gold, silver, copper))
	BtmFeed.scanning = true
	BtmFeed.interval = 1
end
BtmFeed.EndScan = function ()
	BtmFeed.Log(format("BottomFeeder is stopping scanning"))
